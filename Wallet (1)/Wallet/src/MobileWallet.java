...
public class MobileWallet implements Wallet{
    ...
    public void createAccount() {
        ...
        System.out.println("Your mobile account is successfully created");
    }

    @Override
    public void login() {
        System.out.println("Login to your mobile account");
